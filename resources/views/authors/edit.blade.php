            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    ...
                    @if (session()->has('warning'))
                        <div class='bg-red-400 border border-red-800 text-red-700 px-4 py-3 rounded relative'
                            x-data="{ show: true }"
                            ...
                            <span class="absolute top-0 bottom-0 right-0 px-4 py-3.5">
                                <svg @click="show = false" class="fill-current h-6 w-6 text-red-500" role="button" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20">
                                    <title>Close</title>
